...
The current compatibility target is DSH `v0.1.7-alpha.2`; no breaking DSH contract changes were found, and `session-cost` now uses the new projection seam instead of deprecated Session snapshot reads.
...
| --- | --- | --- | --- |
| `packages/system-notification` | `dsh-system-notification-plugin` | `0.1.7-alpha.2.1` | Native macOS / Windows notifications |
| `packages/codex-login` | `dsh-codex-login-plugin` | `0.1.7-alpha.2.1` | Initial ChatGPT / Codex login |
| `packages/codex-usage` | `dsh-codex-usage-plugin` | `0.1.7-alpha.2.1` | Codex quota display |
| `packages/session-cost` | `dsh-session-cost-plugin` | `0.1.7-alpha.2.1` | Session cost display |
| `packages/project-mcp` | `dsh-project-mcp-plugin` | `0.1.7-alpha.2.1` | Project-scoped MCP isolation |
...
For a fixed release, put the version tag before the path. For example, version `v0.1.7-alpha.2.1`:

```sh
# System notifications
dsh plugin --profile web add 'github:zz-zhi54/dsh-plugins#v0.1.7-alpha.2.1&path:packages/system-notification'

# Codex login
dsh plugin --profile web add 'github:zz-zhi54/dsh-plugins#v0.1.7-alpha.2.1&path:packages/codex-login'

# Codex usage
dsh plugin --profile web add 'github:zz-zhi54/dsh-plugins#v0.1.7-alpha.2.1&path:packages/codex-usage'

# Session cost
dsh plugin --profile web add 'github:zz-zhi54/dsh-plugins#v0.1.7-alpha.2.1&path:packages/session-cost'

# Project-scoped MCP
dsh plugin --profile web add 'github:zz-zhi54/dsh-plugins#v0.1.7-alpha.2.1&path:packages/project-mcp'
```
