...
| `packages/project-mcp` | `dsh-project-mcp-plugin` | `0.1.5-rc.2.2` | 项目级 MCP 隔离 |
...
# 项目级 MCP
dsh plugin --profile web add 'github:zz-zhi54/dsh-plugins#v0.1.5-rc.2.2&path:packages/project-mcp'
```
