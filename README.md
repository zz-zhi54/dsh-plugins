...
{
  "name": "dsh-plugins",
  "version": "0.1.6-alpha.2.2",
  "tags": ["deepseek", "deepseek-harness", "dsh", "plugins"],
  "description": "非官方 DeepSeek Harness 插件集合，可从 GitHub 按需安装",
  "icon": "https://raw.githubusercontent.com/zz-zhi54/dsh-plugins/v0.1.6-alpha.2.2/packages/system-notification/assets/dsh.ico",
...
| --- | --- | --- | --- |
| `packages/system-notification` | `dsh-system-notification-plugin` | `0.1.6-alpha.2.2` | macOS / Windows 系统通知 |
| `packages/codex-login` | `dsh-codex-login-plugin` | `0.1.6-alpha.2.2` | 首次 ChatGPT / Codex 登录 |
| `packages/codex-usage` | `dsh-codex-usage-plugin` | `0.1.6-alpha.2.2` | Codex 额度显示 |
| `packages/session-cost` | `dsh-session-cost-plugin` | `0.1.6-alpha.2.2` | Session 费用显示 |
| `packages/project-mcp` | `dsh-project-mcp-plugin` | `0.1.6-alpha.2.2` | 项目级 MCP 隔离 |
...
固定 release 时，在路径前加入版本标签。以版本 `v0.1.6-alpha.2.2` 为例：
